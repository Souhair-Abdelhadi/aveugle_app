...
export default class ChangeContacts extends React.Component {
    ...
    getInput = (index) => {
        ...
        return <View style={styles.inputView} key={index} >
            ...
            }} style={[styles.plusButton,{backgroundColor : 'red'}]} >
    ...
    deletePhone = (index) =>{
        let list = this.state.contacts.filter((value,_index)=>{
            // console.log(index,_index)
            if(index != _index){
                return this.state.contacts[_index]
            }
        })
        // console.log(list)
          ...
          <SafeAreaView style={styles.container}>
            ...
            <View style={styles.body}>
              <TouchableOpacity
                ...
                style={[styles.plusButton,{position : 'absolute',top : "2%",left : "88%"}]}>
                <Text style={styles.plusText}>+</Text>
              </TouchableOpacity>
